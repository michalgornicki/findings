...
function App() {
  ...
  return (
    <div>
      ...
      <img className="image-zoom-thumbnail" onClick={() => setImage(0)} src={data[image + 2].src} alt=""/>
      <img className="image-zoom-thumbnail" onClick={() => setImage(0)} src={data[image + 3].src} alt=""/>
      </div>
      </div>
    : ""}
    </div>
