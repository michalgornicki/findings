...
function App() {
  ...
  return (
    <div>
      ...
      {image < 39 ? <img className="image-zoom-thumbnail" onClick={() => setImage(image + 1)} src={data[image + 1].src} alt=""/> : ""}
      {image < 38 ? <img className="image-zoom-thumbnail" onClick={() => setImage(image + 2)} src={data[image + 2].src} alt=""/> : ""}
      </div>
      </div>
    : ""}
    </div>
